            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 lg:col-span-2">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h2 className="text-lg font-semibold">{t('finance.settings', { defaultValue: 'การตั้งค่าการเงิน (Financial Settings)' })}</h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t('finance.vat_rate', { defaultValue: 'อัตราภาษี (VAT %)' })}
                            </label>
                            <input
                                type="number"
                                step="0.01"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t('finance.interest_rate', { defaultValue: 'อัตราดอกเบี้ย (%)' })}
                            </label>
                            <input
                                type="number"
                                step="0.01"
