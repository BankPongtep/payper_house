...
class AddAddressToAssetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('assets', function (Blueprint $table) {
            $table->string('address_house_no')->nullable()->after('status');
            ...
            $table->string('image_path')->nullable(); // Make existing nullable if it wasn't
        });
    }
